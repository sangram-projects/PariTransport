jQuery(function ($) {
    ...
    $(function () {
        $(".sticky-div").stick_in_parent({ container: $(".sticky-container"), offset_top: 90 });
    });
    $(function () {
    ...
    (function () {
        $(".img-link").magnificPopup({ gallery: { enabled: true }, removalDelay: 300, mainClass: "mfp-with-zoom", type: "image" });
    })();
    (function () {
    ...
    (function () {
        $(".partner-carousel").owlCarousel({ loop: true, margin: 15, responsive: { 0: { items: 2 }, 600: { items: 3 }, 1000: { items: 6 } } });
    ...
    var $latitude = 19.06038547688399,
        $longitude = 73.07957335575455,
        $map_zoom = 16;
    var $marker_url = "img/map-marker.png";
    var style = [{ stylers: [{ hue: "#FE7002" }, { saturation: -10 }, { gamma: 2.15 }, { lightness: 12 }] }];
    (function () {
    ...
    (function () {
        var twitterConfig = { id: "567185781790228482", domId: "twitterWidget", maxTweets: 3, enableLinks: true, showUser: false, showTime: true, showInteraction: false, customCallback: handleTweets };
